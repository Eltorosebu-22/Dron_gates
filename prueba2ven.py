    ...
    for cnt in contours:
        ...
        if num_sides == 3:
            ...
            if 0.95 <= aspect_ratio <= 1.05:
                ...
                shape = "Cuadrado"  # También podría ser un cuadrado
        elif num_sides == 6:
            shape = "Hexagono"
        elif num_sides > 6:
            shape = "Circulo"
...
def sensorOutput():
    ...
    #Desplazamiento
    if areashow<92000 and areashow!=0 and areashow<3000:
        movex=8
...
while True:
    ...
    if Start==0:
        ...
        time.sleep(9)  # Ajusta el tiempo de espera según la altura
        me.send_rc_control(0, 0, 0, 0)
        time.sleep(1)
        Start = 1
